...
import "./MultiSelectDisabled.scss";
  ...
  return (
    <div className="multichoice">
      ...
      <div className="vl-form__input">
        <div className="js-vl-multiselect">
          ...
          >
            ...
            <option value="Duitsland" disabled={isDisabled}>
              Duitsland
            </option>
      ...
      <div className="state">
        ...
        <div>
          Automatically dress/undress on disable: {autoDress ? "Yes" : "No"}
        </div>
      </div>
      <div className="actions">
        <button
          className="vl-button vl-form-col"
          onClick={() => setAutoDress(!autoDress)}
        >
          <span className="vl-button__label">
            {autoDress
              ? "Do not automatically undress+dress on disable"
              : "Automatically undress+dress on disable"}
          </span>
        </button>
        <button
          className="vl-button vl-form-col"
        ...
        <button className="vl-button" onClick={() => undress()}>
          <span className="vl-button__label">Undress component</span>
        </button>
        <button className="vl-button" onClick={() => dress()}>
          <span className="vl-button__label">Dress component</span>
        </button>
      </div>
    </div>
  );
